...
Website: https://username-not-available-not-available.github.io/Anime-Audience-guessimator/AnimeCalculator1.html  
(TRANSPARENCY YEAR SCALING MAXXES OUT AT 20 years and 3.5x for age adjustment due to the fact the model is based on measuring the audience of Modern Otakus sampling from MAL, thus Web 2.0 and post 2006, it should be utilized as a reference and estimation, NOT A CLEAR CENSUS)
